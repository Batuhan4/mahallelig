  ...
  return (
    ...
    >
      <Text
        ...
        style={{ fontFamily: "IBMPlexMono_500Medium", fontSize: 13, letterSpacing: -0.3 }}
      >
        {rankStr}
      </Text>
      <View className="flex-1 pr-2">
        ...
        {sub && (
          <Text
            ...
            style={{ fontFamily: "Inter_500Medium", fontSize: 11, marginTop: 1, letterSpacing: 0.4 }}
            numberOfLines={1}
          >
            {sub.toUpperCase()}
          </Text>
      ...
      <View className="items-end">
        <Text
          className={you ? "text-ivory-50" : "text-navy-900"}
          style={{ fontFamily: "IBMPlexMono_700Bold", fontSize: 15, letterSpacing: -0.4 }}
        >
          {points.toLocaleString("tr-TR")}
        </Text>
        <Text
          className={you ? "text-ivory-100/60" : "text-steel-400"}
          style={{ fontFamily: "Inter_500Medium", fontSize: 9, letterSpacing: 0.6, marginTop: 1 }}
        >
          PUAN
        </Text>
      </View>
